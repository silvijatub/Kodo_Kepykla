<header>
    ...
    <nav class="navbar">
        <ul class="nav-menu">
            <li class = nav-item>
                <button onclick="location.href='aboutus.html'" class="headerButton <?php if (basename($_SERVER['PHP_SELF']) == 'aboutus.html') echo 'active'; ?>">APIE MUS</button>
            </li>
            <li class = nav-item>
            ...
            <li class = nav-item>
                <button onclick="location.href='privacy_policy.html'" class="headerButton <?php if (basename($_SERVER['PHP_SELF']) == 'privacy_policy.html') echo 'active'; ?>">PRIVATUMO POLITIKA</button>
            </li>
            <li class = nav-item>
                <button onclick="location.href='contacts.html'" class="headerButton <?php if (basename($_SERVER['PHP_SELF']) == 'career.html') echo 'active'; ?>">KONTAKTAI</button>
            </li>
            <li class = nav-item>
